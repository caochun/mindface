...
def main():
    ...
    loader_train = create_loader(
        ...
        transform=[ds.vision.Resize((128, 128)), ds.vision.Normalize(mean=[0.485 * 255, 0.456 * 255, 0.406 * 255], std=[0.229 * 255, 0.224 * 255, 0.225 * 255]),ds.vision.HWC2CHW()],
    ...
    time_monitor = TimeMonitor(data_time=True)
    trainer.train(50, loader_train, callbacks=[time_monitor], dataset_sink_mode=args.dataset_sink_mode)
